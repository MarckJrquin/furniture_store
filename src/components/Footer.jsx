                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0 flex flex-col items-center md:items-start">
                        <div className="mb-4 md:mb-0">
                            <Link to={'/home'} >
                                <img src={logo} alt="Concepts life Logo" className="h-10 w-auto rounded-xl"/>
                            </Link>
                        </div>
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 dark:text-gray-200 font-medium mb-7">Concepts Life
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 dark:text-gray-300 font-medium mb-7">More Information</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6">
                                <a href="javascript:;"  className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">
                                    Services
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 dark:text-gray-300 font-medium mb-7">Support</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6">
                                <a href="javascript:;"  className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">
                                    Help Center
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 dark:text-gray-300 font-medium mb-7">Subscribe</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 leading-6 mb-7">
                            Subscribe to our newsletter and get exclusive offers and discounts on your favorite products.
                        </p>
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 ">
                            © Concepts Life 2024, all rights reserved.
                        </span>
